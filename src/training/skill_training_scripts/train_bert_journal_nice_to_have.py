...
INPUT_JSON_CANDIDATES = [
    "data/processed/journal/by_skill_type/skills_nice_to_have.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/journal_nice_to_have_split_manifest_seed13.csv",
]
...
RUN_NAME = "bert_journal_nice_to_have"
