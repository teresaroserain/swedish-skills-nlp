...
INPUT_JSON_CANDIDATES = [
    "data/processed/merged/by_skill_type/skills_hard_skills.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/merged_hard_skills_split_manifest_seed13.csv",
]
...
RUN_NAME = "bert_merged_hard_skills"
