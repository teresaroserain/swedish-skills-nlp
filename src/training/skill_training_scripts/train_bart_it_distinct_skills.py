...
INPUT_JSON_CANDIDATES = [
    "data/processed/IT/by_skill_type/skills_distinct_skills.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/it_distinct_skills_split_manifest_seed13.csv",
]
...
RUN_NAME = "bart_it_distinct_skills"
