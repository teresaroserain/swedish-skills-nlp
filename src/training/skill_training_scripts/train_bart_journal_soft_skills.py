...
INPUT_JSON_CANDIDATES = [
    "data/processed/journal/by_skill_type/skills_soft_skills.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/journal_soft_skills_split_manifest_seed13.csv",
]
...
RUN_NAME = "bart_journal_soft_skills"
