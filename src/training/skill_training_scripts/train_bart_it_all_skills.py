...
INPUT_JSON_CANDIDATES = [
    "data/processed/IT/dataset_clean_merged_5skills.jsonl",
    "data/processed/IT/dataset_clean_merged_5skills.json",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/it_all_skills_split_manifest_seed13.csv",
]
