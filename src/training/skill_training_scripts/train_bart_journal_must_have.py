...
INPUT_JSON_CANDIDATES = [
    "data/processed/journal/by_skill_type/skills_must_have.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/journal_must_have_split_manifest_seed13.csv",
]
...
RUN_NAME = "bart_journal_must_have"
