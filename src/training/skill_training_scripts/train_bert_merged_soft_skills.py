...
INPUT_JSON_CANDIDATES = [
    "data/processed/merged/by_skill_type/skills_soft_skills.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/merged_soft_skills_split_manifest_seed13.csv",
]
...
RUN_NAME = "bert_merged_soft_skills"
...
PREDICTED_SKILL_ALLOWLIST: set[str] = set()
