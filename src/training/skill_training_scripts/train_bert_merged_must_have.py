...
INPUT_JSON_CANDIDATES = [
    "data/processed/merged/by_skill_type/skills_must_have.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/merged_must_have_split_manifest_seed13.csv",
]
...
RUN_NAME = "bert_merged_must_have"
