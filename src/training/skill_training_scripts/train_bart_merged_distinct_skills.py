...
INPUT_JSON_CANDIDATES = [
    "data/processed/merged/by_skill_type/skills_distinct_skills.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/merged_distinct_skills_split_manifest_seed13.csv",
]
...
RUN_NAME = "bart_merged_distinct_skills"
