...
INPUT_JSON_CANDIDATES = [
    "data/processed/merged/by_skill_type/skills_nice_to_have.jsonl",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/merged_nice_to_have_split_manifest_seed13.csv",
]
...
RUN_NAME = "bart_merged_nice_to_have"
