...
INPUT_JSON_CANDIDATES = [
    "data/processed/journal/dataset_clean_merged_5skills.jsonl",
    "data/processed/journal/dataset_clean_merged_5skills.json",
]
SPLIT_MANIFEST_CANDIDATES = [
    "data/splits/manifests/journal_all_skills_split_manifest_seed13.csv",
]
...
RUN_NAME = "bart_journal_all_skills"
